...
%    y = imopen(y,ones(3,3)*params.th1,[1,1])
%    y = imerode(y,ones(3,3)*params.th1,[1,1])
...
%            y[pos[0],pos[1],:]=m*ratio;
            ...
            y[pos[0],pos[1],:]=x[pos[0],pos[1],:]+b*(mask[pos[0],pos[1]]);
...
%    video_file_sdr="F:/movie_trailers/The Angry Birds Movie (2016) DVDRip LAT-ZeiZ.mkv"
    %video_file_sdr="F:/movie_trailers/Star_Wars_Episode_VII_The_Force_Awakens_2015_Trailer_B_5.1-1080p-HDTN.mp4"
...
%    return
    ...
    tmo_params.midOut:scalar= 0.50 %0.063 %This value could be change dynamically .. TODO 0.18 HDR
    tmo_params.hdrMax:scalar=max_value %HDR Max value default (in image)
    tmo_params.peak_luminance:scalar=0.8 %0.8  %0.67 %Peak luminance in TMO
    updateBC(tmo_params);
    ...
    eb_params.th2= 210/255  %Saturation
